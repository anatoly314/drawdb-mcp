...
const bn = {
  translation: {
    ...
    are_you_sure_flush_storage:
      "আপনি কি নিশ্চিত যে আপনি স্টোরেজ ফ্লাশ করতে চান? এই পদক্ষেপের ফলে আপনার সকল ডায়াগ্রাম ও কাস্টম টেমপ্লেট স্থায়ীভাবে মুছে যাবে এবং আর ফিরে পাওয়া যাবে না।",
    ...
    only_mysql_supported: "*এখন পর্যন্ত শুধুমাত্র MySQL স্ক্রিপ্ট সাপোর্ট করে।",
    blank: "খালি",
    filename: "ফাইলের নাম",
    ...
    duplicate_fields: "টেবিল '{{tableName}}'-এর '{{fieldName}}' নামে ডুপ্লিকেট ফিল্ড আছে",
    duplicate_index: "টেবিল '{{tableName}}'-এর '{{indexName}}' নামে ডুপ্লিকেট ইনডেক্স আছে",
    ...
    duplicate_type_fields: "টাইপ '{{typeName}}'-এর '{{fieldName}}' নামে ডুপ্লিকেট ফিল্ড আছে",
    ...
    generic: "জেনেরিক",
    generic_description:
      "জেনেরিক ডায়াগ্রামগুলি যে কোনও SQL ফ্লেভারে এক্সপোর্ট করা যেতে পারে কিন্তু এতে অল্প কিছু ডেটা টাইপেরই সাপোর্ট আছে।",
    enums: "এনামস",
    ...
    share_info: "*এই লিঙ্ক শেয়ার করলে লাইভ রিয়েল-টাইম সহযোগিতা সৃষ্টি হবে না।",
