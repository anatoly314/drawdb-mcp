...
const pa_pk = {
  translation: {
    ...
    redo: "دوبارہ کرو",
    clear: "صاف کرو",
    are_you_sure_clear: "تُسی پکا ایہہ ڈایاگرام صاف کرنا چاہندے او؟ ایہہ واپس نہیں ہو سکدا۔",
    cut: "کٹ کرو",
    copy: "کاپی کرو",
    paste: "چپکاؤ",
    ...
    strict_mode_is_on_no_issues: "سخت موڈ بند اے اس لئی کوئی مسئلے نہیں وکھائے جا رہے۔",
    name: "ناں",
    type: "قسم",
    null: "نل",
    not_null: "نل نہیں",
