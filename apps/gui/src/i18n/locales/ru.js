...
const ru = {
  translation: {
    ...
    redo: "Повторить",
    clear: "Очистить",
    are_you_sure_clear: "Вы уверены, что хотите очистить диаграмму? Это необратимо.",
    cut: "Вырезать",
    copy: "Копировать",
    paste: "Вставить",
    ...
    strict_mode_is_on_no_issues: "Строгий режим выключен, поэтому проблемы не будут отображаться.",
    name: "Имя",
    type: "Тип",
    null: "Null",
    not_null: "Не Null",
    ...
    upload_sql_to_generate_diagrams: "Загрузите файл sql для автогенерации ваших таблиц и колонок.",
    overwrite_existing_diagram: "Перезаписать существующую диаграмму",
    only_mysql_supported: "*На данный момент поддерживается только загрузка скриптов MySQL.",
    blank: "Пустой",
    filename: "Имя файла",
    ...
    duplicate_index: "Дублирование индекса по имени '{{indexName}}' в таблице '{{tableName}}'",
    ...
    duplicate_type_fields: "Дублирование полей типа по имени '{{fieldName}}' в типе '{{typeName}}'",
