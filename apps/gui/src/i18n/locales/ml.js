...
const ml = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "'{{tableName}}' ടേബിളിലെ '{{fieldName}}' കോളം പാരമ്പര്യ നിർവ്വചനത്തോട് ലയിപ്പിക്കും",
    ...
    are_you_sure_delete_diagram:
      "നിങ്ങൾക്ക് ഈ ഡയഗ്രം ഡിലീറ്റ് ചെയ്യണമെന്ന് ഉറപ്പാണോ? ഈ പ്രവർത്തനം തിരിച്ചുകൂട്ടൽ സാധ്യമല്ല.",
    ...
    are_you_sure_flush_storage:
      "സ്റ്റോറേജ് ഫ്ലഷ് ചെയ്യണമെന്ന് ഉറപ്പാണോ? ഇത് നിങ്ങളുടെ എല്ലാ ഡയഗ്രമുകളും കസ്റ്റം ടെംപ്ലേറ്റുകളും ഇല്ലാതാക്കും.",
    ...
    only_mysql_supported:
      "*ഇപ്പോൾ വേണ്ടത്ര MySQL സ്ക്രിപ്റ്റുകൾ മാത്രമേ ലോഡ് ചെയ്യാൻ സപ്പോർട്ട് ഉള്ളൂ.",
    blank: "ശൂന്യം",
    filename: "ഫയൽനാമം",
    ...
    no_values_for_field:
      "'{{tableName}}' ടേബിളിലെ '{{fieldName}}' ഫീൽഡ് `{{type}}` ടൈപ്പ് ആണെങ്കിലും വിലകൾ നിർവചിച്ചിട്ടില്ല",
    default_doesnt_match_type:
      "'{{tableName}}' ടേബിളിലെ '{{fieldName}}' ഫീൽഡിനുള്ള ഡിഫോൾട് വില അതിന്റെ ടൈപ്പുമായി പൊരുത്തപ്പെടുന്നില്ല",
    not_null_is_null:
      "'{{tableName}}' ടേബിളിലെ '{{fieldName}}' ഫീൽഡ് NOT NULL ആണെങ്കിലും ഡിഫോൾട് NULL ആണ്",
    ...
    no_values_for_type_field:
      "'{{typeName}}' ടൈപ്പിലെ '{{fieldName}}' ഫീൽഡ് `{{type}}` ടൈപ്പ് ആണെങ്കിലും വിലകൾ നിർവചിച്ചിട്ടില്ല",
    duplicate_type_fields:
      "'{{typeName}}' ടൈപ്പിൽ '{{fieldName}}' എന്ന പേരിൽ ഡുപ്ലിക്കേറ്റ് ഫീൽഡുകൾ",
    ...
    generic: "ജനറിക്",
    generic_description:
      "ജനറിക് ഡയഗ്രമുകൾ ഏത് SQL ഫ്ലേവറിലേക്കും എക്സ്പോർട്ട് ചെയ്യാം, പക്ഷേ കുറച്ച് ഡാറ്റാ ടൈപ്പുകൾ മാത്രമേ സപ്പോർട്ട് ചെയ്യൂ.",
    enums: "എനംസ്",
