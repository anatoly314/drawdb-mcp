...
const ka = {
  translation: {
    ...
    redo: "ಮತ್ತೆ ಮಾಡಿ",
    clear: "ಸ್ಪಷ್ಟ",
    are_you_sure_clear: "ನೀವು ಚಿತ್ರವನ್ನು ಸ್ಪಷ್ಟಗೊಳಿಸಲು ಖಚಿತವಾಗಿ ಬಯಸುತ್ತೀರಾ? ಇದು ಬದಲಾಯಿಸಲಾಗದು.",
    cut: "ಕತ್ತರಿಸಿ",
    copy: "ನಕಲಿಸಿ",
    paste: "ಅಂಟಿಸಿ",
    duplicate: "ನಕಲು",
    ...
    strict_mode_is_on_no_issues: "ಕಠಿಣ ಮೋಡ್ ಆಫ್ ಆಗಿದೆ ಆದ್ದರಿಂದ ಯಾವುದೇ ಸಮಸ್ಯೆಗಳು ತೋರಿಸಲಾಗುವುದಿಲ್ಲ.",
    name: "ಹೆಸರು",
    type: "ಪ್ರಕಾರ",
    null: "ಶೂನ್ಯ",
    not_null: "ಶೂನ್ಯವಲ್ಲ",
    ...
    only_mysql_supported: "*ಈಗಾಗಲೇ MySQL ಸ್ಕ್ರಿಪ್ಟ್‌ಗಳನ್ನು ಮಾತ್ರ ಲೋಡ್ ಮಾಡುವುದು ಬೆಂಬಲಿತವಾಗಿದೆ.",
    blank: "ಖಾಲಿ",
    filename: "ಫೈಲ್ ಹೆಸರು",
    ...
    duplicate_index: "ಕೋಷ್ಟಕ '{{tableName}}' ನಲ್ಲಿ ಹೆಸರಿನ ಮೂಲಕ ನಕಲು ಸೂಚಿ '{{indexName}}'",
    ...
    share_info: "* ಈ ಲಿಂಕ್ ಅನ್ನು ಹಂಚಿಕೊಳ್ಳುವುದರಿಂದ ಲೈವ್ ರಿಯಲ್-ಟೈಮ್ ಸಹಯೋಗ ಸೆಷನ್ ರಚಿಸಲಾಗುವುದಿಲ್ಲ.",
  },
};
